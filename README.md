...
.  
### этапы работы:  
После того, как мы скачали ___Каталог патриотической музыки___ и исследовали его, мы определили группу данных необходимых для нашего анализа. Каталог был составлен из 8000 строк и отсортирован в алфавитном порядке по имени композитора, написавшего музыкальное произведение. Из таблицы мы выделили интересующие нас столбцы, а именно: ___год написания песни___ и ___ключевое слово___, опустив название произведения, его жанр и т.п. С помощью библиотеки ___pandas___ мы смогли установить частоту попадания музыкальных произведений определенного года в ___Каталог патриотической музыки___, а затем в рамках каждого года выявить самое часто встречающееся в музыкальных произведениях ключевое слово.  
...
Для интерпретации результатов и оформления вывода важно отметить несколько моментов. Во-первых, в выборку строк, указывающих ___год написания песни___ не были включены из каталога строки с пустыми значениями, то есть с неизвестной датой написания, а также строки, содержащие временной отрезок, а не определенный год. Таким образом из 8000 строк в нашей выборке осталось меньше половины - 3818. Во-вторых, данный каталог, как указано на сайте Портала открытых данных Минкультуры России, был составлен Региональным благотворительным общественным фондом Тихона Хренникова. Как на сайте, так и в самом документе каталога нет комментариев относительно процесса его наполнения: какие были критерии отбора, кто именно его заполнял и т.д. Следовательно попавшие в него музыкальные произведения не представляют собой исчерпывающий и полный перечень патриотических песен.  
